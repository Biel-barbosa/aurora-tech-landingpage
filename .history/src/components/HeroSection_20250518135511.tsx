          ...
          <div className="w-full lg:w-1/2 space-y-8 animate-fade-in">
            ...
            <div className="pt-8">
              ...
              <div className="flex flex-wrap items-center gap-8">
                <img 
                  src="https://assets.vercel.com/image/upload/front/nextjs/grey-lockup.svg" 
                  alt="Next.js" 
                  className="h-6 opacity-70 dark:invert" 
                />
                <img 
                  src="https://companieslogo.com/img/orig/SHOP.TO-c7489273.png?t=1633218243" 
                  alt="Shopify" 
                  className="h-6 opacity-70 dark:invert" 
                />
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/8/89/Slack_Technologies_Logo_2019_%28white%29.svg" 
                  alt="Slack" 
                  className="h-6 opacity-70 dark:invert" 
                />
                <img 
